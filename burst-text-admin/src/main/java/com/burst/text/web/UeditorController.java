...
import com.burst.text.util.JsonUtil;
                ...
                if (multipartResolver.isMultipart(request)) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (file != null) {
                            ...
                            String fileType = "burstImgs";
                            String uploadPath = fileService.getUploadUrl(fileType);
                            ...
                            Map<String, String> upMap = fileService.getAccessPath(retPath, fileName);
